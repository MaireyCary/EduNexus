...
class Config:
    ...
    TASK_MODULES: Dict[str, Dict[str, Any]] = {
        ...
        "leave_approval_system": {
            "name": "请假审批",
            "module_path": "modules.leave_approval_system",
            "keywords": [
                "假条", "请假", "公假", "事假"
            ],
            "required_params": ["student_ids", "student_names"]
        },
        "exam_scheduling": {
            "name": "考试信息安排",
        ...
        "exam_result_analysis": {
            "name": "考试成绩",
            "module_path": "modules.exam_result_analysis",
            "keywords": [
                "成绩", "科目成绩", "考试情况", "分数"
            ],
            "required_params": ["operation_type", "class_name"]
        }
    }
